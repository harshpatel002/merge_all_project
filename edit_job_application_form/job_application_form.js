...
app.post("/form", (req, res) => {
    ...
    // var to = req.body.to;
    // var languageknown = req.body.language;
    ...
    // // }
    // var technologyknown = req.body.technology;
    // var reference_name1 = req.body.reference_name1;
    // var reference_contact1 = req.body.reference_contact1;
    // var reference_relation1 = req.body.reference_relation1;
    // var reference_name2 = req.body.reference_name2;
    // var reference_contact2 = req.body.reference_contact2;
    // var reference_relation2 = req.body.reference_relation2;
    ...
    conn.query(`select * from candidate_basic_info where delete_row is null;`, function (err, data) {
        if (err) throw err;
        res.render('job_application_form_data_show.ejs', { data })
    })
})
